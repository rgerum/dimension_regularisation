...
if p.weight_share(False) is True:
...
model = keras.models.Sequential([
    ...
    Conv2DNew(p.conv1(16), 5, activation='relu', kernel_initializer='he_uniform'),#, padding='same'),
...
#    keras.layers.MaxPool2D(2),
    ...
    Conv2DNew(p.conv2(8), 5, activation='relu', kernel_initializer='he_uniform'),#, padding='same'),
...
#    keras.layers.MaxPool2D(2),
    ...
    Conv2DNew(p.conv3(4), 5, activation='relu', kernel_initializer='he_uniform'),#, padding='same'),
...
#    keras.layers.MaxPool2D(2),
    ...
    keras.layers.Dense(units=p.dense1(16), activation='relu'),
