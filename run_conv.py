...
parser.add_argument('--conv1', default=64, type=int, help='units in first hidden layer')
parser.add_argument('--reg1', default=0, type=float, help='units in first hidden layer')
parser.add_argument('--conv2', default=64, type=int, help='units in first hidden layer')
...
model = keras.models.Sequential([
    ...
    keras.layers.Conv2D(args.conv1, 3, activation='relu'),
    keras.layers.MaxPool2D(2),
    DimensionReg(args.reg1, 1, "alpha_1"),
    keras.layers.Dropout(0.5),

    keras.layers.Conv2D(args.conv2, 3, activation='relu'),
    keras.layers.MaxPool2D(2),
