...
from dimension_regularisation.dim_includes import command_line_parameters as p, PCAreduce


def main(dataset="cifar10", dense1=2000,
    ...
    x_train, x_test = PCAreduce(x_train, x_test, pca_dim)
